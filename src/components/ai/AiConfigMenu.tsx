...
export const AiConfigMenu: React.FC = () => {
    ...
    const handleVerifyKey = async () => {
        ...
        setKeyTestResult({ success: res.success, message: res.success ? `Connected successfully! Loaded ${res.models.length} models.` : res.message });
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button 
                ...
                className="top-header-ai-featured-btn whitespace-nowrap shrink-0"
                style={{ background: 'var(--bg-card)', color: 'var(--text-main)', border: '1px solid var(--border-glass)', whiteSpace: 'nowrap' }}
                title="AI Configuration"
            >
                <i className="fa-solid fa-gear shrink-0"></i>
                <span className="whitespace-nowrap shrink-0">AI Config</span>
            </button>
            ...
            {showApiConfig && (
                ...
                >
                    <h3 className="text-sm font-bold mb-3" style={{ color: 'var(--text-main)' }}>Gemini API Configuration</h3>
